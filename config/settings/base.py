...
# sme_material_apps/
APPS_DIR = ROOT_DIR / "sme_material_apps"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "sme_material_apps.contrib.sites.migrations"}
...
MIDDLEWARE = [
    ...
    "sme_material_apps.jwt_middleware.JWTAuthenticationMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "sme_material_apps.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Kelwy Oliveira""", "kelwy.oliveira@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
# ACCOUNT_ADAPTER = "sme_material_apps.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
# SOCIALACCOUNT_ADAPTER = "sme_material_apps.users.adapters.SocialAccountAdapter"
