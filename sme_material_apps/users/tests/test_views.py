...
from sme_material_apps.users.models import User
from sme_material_apps.users.tests.factories import UserFactory
from sme_material_apps.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
