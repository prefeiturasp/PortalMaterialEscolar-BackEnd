...
@patch('sme_material_apps.proponentes.models.proponente.Proponente.comunicar_pre_cadastro')
def test_comunica_pre_cadastro(mock_comunicar_pre_cadastro):
    baker.make('Proponente')
    assert mock_comunicar_pre_cadastro.called


@patch('sme_material_apps.proponentes.models.proponente.Proponente.comunicar_cadastro')
